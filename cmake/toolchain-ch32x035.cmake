...
set(CPU_FLAGS "-march=rv32imac_zicsr -mabi=ilp32 -fmessage-length=0 -msmall-data-limit=0 -msave-restore -fsigned-char")
...
set(LD_FLAGS "-march=rv32imac -mabi=ilp32e -Wl,--gc-sections -Wl,--print-memory-usage -nostartfiles")
